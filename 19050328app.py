...
for d in dates:
    ...
    for doc in docs:
        ...
        if op not in op_daily:
            op_daily[op] = {}
        if d not in op_daily[op]:
            op_daily[op][d] = {"taken": 0, "completed": 0, "skipped": 0}
        op_daily[op][d]["taken"] = taken
        op_daily[op][d]["completed"] = completed
        op_daily[op][d]["skipped"] = skipped
